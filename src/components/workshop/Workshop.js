...
const Workshop = () => {
  ...
  const photo=[prof_icon,image_icon,color_icon,task_icon,meme_icon,chart_icon,aura_icon,soon_icon]
  const build_names=["Profile","Image","Colour","Schedule","Meme","Chart","Aura","Soon"]
  const desc="Professional builder helps to build different documents required for coorporate work. It include Resume, CV, profile builder.";
  return (
    <>
      <WorkshopDiv>
          ...
          <div className="scroll-up">
            <div className="work-main">
              ...
              {build_names.map((val,ind)=><Card key={ind} index={ind} name={val} desc={desc} url={photo[ind]}/>)}
